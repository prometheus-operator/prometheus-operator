...
func parseFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&cfg.AlertmanagerDefaultVersion, "alertmanager-default-version", operator.DefaultAlertmanagerVersion, "Alertmanager default version")
	fs.StringVar(&cfg.PrometheusDefaultVersion, "prometheus-default-version", operator.DefaultPrometheusVersion, "Prometheus default version")
	fs.StringVar(&cfg.ThanosDefaultVersion, "thanos-default-version", operator.DefaultThanosVersion, "Thanos default version")
