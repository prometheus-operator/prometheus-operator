...
func init() {
	...
	flagset.BoolVar(&cfg.ReloaderConfig.EnableProbes, "enable-config-reloader-probes", false, "Config Reloader Open LivenessProbe and ReadinessProbe. Default: false")
