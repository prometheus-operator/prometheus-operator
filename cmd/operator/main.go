...
func init() {
	...
	flagset.BoolVar(&cfg.StrictNamespaceSelection, "strict-namespace-selection", true, "Prometheus Cluster Namespace must match ServiceMonitor and Rules Namespaces")
