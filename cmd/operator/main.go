...
func init() {
	...
	flagset.Var(&cfg.ReadinessProbe, "config-reloader-readiness-probe", "Config Reloader ReadinessProbe")
	flagset.Var(&cfg.LivenessProbe, "config-reloader-liveness-probe", "Config Reloader LivenessProbe")
