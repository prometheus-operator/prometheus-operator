...
func init() {
	...
	flagset.StringVar(&cfg.ReloaderConfig.PrometheusReplicaVal, "prometheus-config-reloader-replicaval", defaultPrometheusReplicaVal, "Prometheus config prometheus_replica var")
