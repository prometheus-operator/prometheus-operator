...
var (
	...
	CRDMonitoringRule = rbacv1.PolicyRule{
		...
		ResourceNames: []string{
			"alertmanagers.azmonitoring.coreos.com",
			"podmonitors.azmonitoring.coreos.com",
			"probes.azmonitoring.coreos.com",
			"prometheuses.azmonitoring.coreos.com",
			"prometheusrules.azmonitoring.coreos.com",
			"servicemonitors.azmonitoring.coreos.com",
			"thanosrulers.azmonitoring.coreos.com",
		},
