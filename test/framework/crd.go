...
func (f *Framework) CreateOrUpdateCRDAndWaitUntilReady(ctx context.Context, crdName, exampleDir string, listFunc func(opts metav1.ListOptions) (runtime.Object, error)) error {
