...
func testPrometheusInstanceNamespacesAllNs(t *testing.T) {
	...
	_, err := framework.CreateOrUpdatePrometheusOperator(context.Background(), operatorNs, nil, nil, []string{instanceNs}, nil, false, true, true, true)
	if err != nil {
		t.Fatal(err)
	}
...
func testPrometheusInstanceNamespacesDenyList(t *testing.T) {
	...
	_, err := framework.CreateOrUpdatePrometheusOperator(context.Background(), operatorNs, nil, []string{deniedNs, instanceNs}, []string{instanceNs}, nil, false, true, true, true)
	if err != nil {
		t.Fatal(err)
	}
...
func testPrometheusInstanceNamespacesAllowList(t *testing.T) {
	...
	_, err := framework.CreateOrUpdatePrometheusOperator(context.Background(), operatorNs, []string{allowedNs}, nil, []string{instanceNs}, nil, false, false, true, true)
	if err != nil {
		t.Fatal(err)
	}
...
func testPrometheusInstanceNamespacesNamespaceNotFound(t *testing.T) {
	...
	_, err := framework.CreateOrUpdatePrometheusOperator(context.Background(), operatorNs, []string{"notfound", allowedNs}, nil, []string{"notfound", instanceNs}, nil, false, true, true, true)
	if err != nil {
		t.Fatal(err)
	}
