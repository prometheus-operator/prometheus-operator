...
var OAuth2CELTestCases = []scrapeCRDTestCase{
	...
	// clientSecret: required when grantType is 'ClientCredentials' or empty
	{
		name: "OAuth2 clientSecret required with ClientCredentials grantType",
		scrapeConfigSpec: monitoringv1alpha1.ScrapeConfigSpec{
			OAuth2: &monitoringv1.OAuth2{
				ClientID:  monitoringv1.SecretOrConfigMap{Secret: &corev1.SecretKeySelector{LocalObjectReference: corev1.LocalObjectReference{Name: "secret"}, Key: "client-id"}},
				GrantType: ptr.To(monitoringv1.GrantTypeClientCredentials),
	...
	{
		name: "OAuth2 clientSecret required with empty grantType",
		scrapeConfigSpec: monitoringv1alpha1.ScrapeConfigSpec{
			OAuth2: &monitoringv1.OAuth2{
				ClientID: monitoringv1.SecretOrConfigMap{Secret: &corev1.SecretKeySelector{LocalObjectReference: corev1.LocalObjectReference{Name: "secret"}, Key: "client-id"}},
				TokenURL: "https://example.com/token",
	...
	// clientCertificateKey: required when grantType is 'JWTBearer'
	{
		name: "OAuth2 clientCertificateKey required with JWTBearer grantType",
		scrapeConfigSpec: monitoringv1alpha1.ScrapeConfigSpec{
			OAuth2: &monitoringv1.OAuth2{
				ClientID:  monitoringv1.SecretOrConfigMap{Secret: &corev1.SecretKeySelector{LocalObjectReference: corev1.LocalObjectReference{Name: "secret"}, Key: "client-id"}},
				GrantType: ptr.To(monitoringv1.GrantTypeJWTBearer),
