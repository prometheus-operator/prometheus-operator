...
func testOperatorUpgrade(t *testing.T) {
	...
	_, err = previousVersionFramework.CreateOrUpdatePrometheusOperator(context.Background(), ns, nil, nil, nil, nil, true, true, false, false)
	if err != nil {
		t.Fatal(err)
	}
	...
	finalizers, err := framework.CreateOrUpdatePrometheusOperator(context.Background(), ns, nil, nil, nil, nil, true, true, true, true)
	if err != nil {
		t.Fatal(err)
	}
