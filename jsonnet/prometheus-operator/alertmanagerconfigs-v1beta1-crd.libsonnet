                ...
                items: {
                  ...
                  properties: {
                    ...
                    msteamsv2Configs: {
                      ...
                      items: {
                        description: 'MSTeamsV2Config configures notifications via Microsoft Teams.\nIt requires Alertmanager >= 0.28.0.',
                        properties: {
                          httpConfig: {
                            description: 'HTTP client configuration.',
                            properties: {
                          ...
                          webhookUrl: {
                            description: 'MSTeams webhook URL. It is mutually exclusive with `webhookUrl`.\nEither `webhookUrl` or `webhookUrlFile` are required.',
                            properties: {
                              key: {
                                description: 'The key of the secret to select from.  Must be a valid secret key.',
                                type: 'string',
                          ...
                          webhookUrlFile: {
                            description: 'File to read the MSTeams webhook URL from.',
                            type: 'string',
                          },
                        },
                        type: 'object',
