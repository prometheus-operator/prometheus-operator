...
{ spec+: { versions+: [
  {
    ...
    schema: {
      openAPIV3Schema: {
        description: 'AlertmanagerConfig is used to define configurations for Prometheus Alertmanager, specifying how alerts are grouped and notified to external systems.',
        properties: {
          apiVersion: {
