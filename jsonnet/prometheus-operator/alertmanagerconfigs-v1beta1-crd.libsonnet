                  ...
                  properties: {
                    ...
                    jiraConfigs: {
                      ...
                      items: {
                        properties: {
                          apiURL: {
                            description: 'The Jira API URL i.e. https://api.jira.com.\nIf not specified, default API URL will be used.',
                            pattern: '^https?://.+$',
                            type: 'string',
                          },
                          description: {
                          ...
                          issueType: {
                            description: 'The Jira issue type (e.g. bug).',
                            type: 'string',
                          },
                          labels: {
                            description: 'A list of labels added to the issue. Template expressions are supported.',
                            items: {
                              type: 'string',
                            },
                            type: 'array',
                          ...
                          project: {
                            description: 'The Jira project where issues are created.',
                            type: 'string',
                          },
                          reopenDuration: {
