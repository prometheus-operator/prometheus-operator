...
* [FEATURE] Add Azure Workload Identity authentication support for remote write configuration in Prometheus and PrometheusAgent CRDs. Requires Prometheus >= v3.7.0 or Thanos >= v0.41.0. #8118
