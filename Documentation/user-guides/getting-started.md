  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        - --prometheus-config-reloader=quay.io/prometheus-operator/prometheus-config-reloader:v0.38.2
        image: quay.io/prometheus-operator/prometheus-operator:v0.38.2
        name: prometheus-operator
        ports:
        - containerPort: 8080
          name: http
