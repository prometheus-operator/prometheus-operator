...
instance. Defaults to &lsquo;alertmanager-<alertmanager-name>&rsquo;
The secret is mounted into /etc/alertmanager/config.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Targets defines a set of static and/or dynamically discovered targets to be probed using the prober.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Timeout for scraping metrics from the Prometheus exporter.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Maximum amount of disk space used by blocks. Supported units: B, KB, MB, GB, TB, PB, EB. Ex: <code>512MB</code>.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Interval between consecutive scrapes. Default: <code>1m</code></p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Interval between consecutive evaluations. Default: <code>1m</code></p>
</td>
</tr>
<tr>
<td>
...
<code>web</code><br/>
<em>
<a href="#monitoring.coreos.com/v1.WebSpec">
WebSpec
</a>
</em>
</td>
<td>
<p>WebSpec defines the web command line flags when starting Prometheus.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>If specified, the remote_read spec. This is an experimental feature, it may change in any upcoming release in a breaking way.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>OverrideHonorLabels if set to true overrides all user configured honor_labels.
If HonorLabels is set in ServiceMonitor or PodMonitor to true, this overrides honor_labels to false.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>IgnoreNamespaceSelectors if set to true will ignore NamespaceSelector settings from
the podmonitor and servicemonitor configs, and they will only discover endpoints
within their current namespace.  Defaults to false.</p>
</td>
</tr>
<tr>
<td>
...
<ol>
<li>all user-metrics (created by <code>ServiceMonitor</code>, <code>PodMonitor</code> and <code>ProbeConfig</code> object) and</li>
...
Make sure both ruleNamespace and ruleName are set for each pair</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Most recent observed status of the Prometheus cluster. Read-only. Not
included when requesting from the apiserver, only from the Prometheus
Operator API itself. More info:
<a href="https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></p>
</td>
...
<td>
<p>Chooses the label of the Kubernetes <code>Endpoints</code>.
Its value will be used for the <code>job</code>-label&rsquo;s value of the created metrics.</p>
<p>Default &amp; fallback value: the name of the respective Kubernetes <code>Endpoint</code>.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>SafeAuthorization</code><br/>
<em>
<a href="#monitoring.coreos.com/v1.SafeAuthorization">
SafeAuthorization
</a>
...
<td>
<p>
(Members of <code>SafeAuthorization</code> are embedded into this type.)
</p>
</td>
</tr>
<tr>
...
<p>
(<em>Appears on:</em><a href="#monitoring.coreos.com/v1.AlertmanagerSpec">AlertmanagerSpec</a>, <a href="#monitoring.coreos.com/v1.EmbeddedPersistentVolumeClaim">EmbeddedPersistentVolumeClaim</a>, <a href="#monitoring.coreos.com/v1.PrometheusSpec">PrometheusSpec</a>, <a href="#monitoring.coreos.com/v1.ThanosRulerSpec">ThanosRulerSpec</a>)
</p>
<div>
...
<td>
<em>(Optional)</em>
<p>This field can be used to specify either:
...
<td>
<em>(Optional)</em>
<p>Specifies the object from which to populate the volume with data, if a non-empty
...
<td>
<p>HTTP path to scrape for metrics.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Timeout after which the scrape is ended</p>
</td>
</tr>
<tr>
<td>
...
<div>
<p>ProbeTargetIngress defines the set of Ingress objects considered for probing.</p>
</div>
<table>
<thead>
<tr>
...
<td>
<p>Select Ingress objects by labels.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>Select Ingress objects by namespace.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>RelabelConfigs to apply to samples before ingestion.
More info: <a href="https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config">https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config</a></p>
</td>
</tr>
</tbody>
...
<td>
<p>Targets is a list of URLs to probe using the configured prober.</p>
</td>
</tr>
<tr>
<td>
...
<div>
<p>ProbeTargets defines a set of static and dynamically discovered targets for the prober.</p>
</div>
<table>
<thead>
<tr>
...
<td>
<p>StaticConfig defines static targets which are considers for probing.
...
<td>
<p>Ingress defines the set of dynamically discovered ingress objects which hosts are considered for probing.</p>
</td>
</tr>
</tbody>
</table>
...
<div>
<p>PrometheusStatus is the most recent observed status of the Prometheus cluster. Read-only. Not
included when requesting from the apiserver, only from the Prometheus
Operator API itself. More info:
<a href="https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status">https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</a></p>
</div>
...
<div>
<p>RemoteReadSpec defines the remote_read configuration for prometheus.</p>
</div>
<table>
<thead>
<tr>
...
<td>
<p>The name of the remote read queue, must be unique if specified. The name
...
<td>
<p>Enables sending of exemplars over remote write. Note that exemplar-storage itself must be enabled using the enableFeature option for exemplars to be scraped in the first place.  Only valid in Prometheus versions 2.27.0 and newer.</p>
</td>
</tr>
<tr>
<td>
...
<p>
(<em>Appears on:</em><a href="#monitoring.coreos.com/v1.PodMetricsEndpointTLSConfig">PodMetricsEndpointTLSConfig</a>, <a href="#monitoring.coreos.com/v1.ProbeTLSConfig">ProbeTLSConfig</a>, <a href="#monitoring.coreos.com/v1.TLSConfig">TLSConfig</a>)
</p>
<div>
...
<p>
(<em>Appears on:</em><a href="#monitoring.coreos.com/v1.AlertmanagerSpec">AlertmanagerSpec</a>, <a href="#monitoring.coreos.com/v1.PrometheusSpec">PrometheusSpec</a>, <a href="#monitoring.coreos.com/v1.ThanosRulerSpec">ThanosRulerSpec</a>)
</p>
<div>
...
<h3 id="monitoring.coreos.com/v1.WebSpec">WebSpec
</h3>
<p>
(<em>Appears on:</em><a href="#monitoring.coreos.com/v1.PrometheusSpec">PrometheusSpec</a>)
</p>
<div>
<p>WebSpec defines the query command line flags when starting Prometheus.</p>
</div>
<table>
<thead>
<tr>
...
<p>
(<em>Appears on:</em><a href="#monitoring.coreos.com/v1.WebSpec">WebSpec</a>)
</p>
<div>
