...
1. **Watch Silence CRDs**: Detect creation, updates, and deletions
2. **Watch Alertmanager CRDs**: React to changes in silence selectors
...
**Controller Failures**:
- **Leader Election**: Only active controller processes silences to avoid conflicts
