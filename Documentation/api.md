...
| shardingLabels | EXPERIMENTAL: The labels to use as the sharding key(s). By default sharding is done on the content of the `__address__` target meta-label. | []string | false |
