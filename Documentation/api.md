...
| hostAliases | HostAlias holds the mapping between IP and hostnames that will be injected as an entry in the pod's hosts file, if specified. This is only valid for non-hostNetwork pods. | []v1.HostAlias | false |
