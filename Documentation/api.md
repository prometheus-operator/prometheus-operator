...
| ephemeral | EphemeralVolumeSource to be used by the Prometheus StatefulSets. More info: https://kubernetes.io/docs/concepts/storage/ephemeral-volumes/#generic-ephemeral-volumes | *v1.EphemeralVolumeSource | false |
