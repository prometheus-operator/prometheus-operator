...
| alertRelabelConfigSelector | *Experimental* AlertRelabelConfigs to be selected for this Prometheus. | *[metav1.LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#labelselector-v1-meta) | false |
| alertRelabelConfigNamespaceSelector | *Experimental* Namespaces to be selected for AlertRelabelConfig discovery. If nil, only check own namespace. | *[metav1.LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#labelselector-v1-meta) | false |
