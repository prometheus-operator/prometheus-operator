...
| patchStatefulSet | PatchStatefulSet allows injecting arbitrary field to Alertmanager StatefulSet. User is advised to use this field carefully as this field will do overwriting when there is conflict between PatchStatefulSet and the original StatefulSet. | *appsv1.StatefulSet | false |
...
| minReadySeconds | Minimum number of seconds for which a newly created pod should be ready without any of its container crashing for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready) This is an alpha field and requires enabling StatefulSetMinReadySeconds feature gate. | *uint32 | false |
| patchStatefulSet | PatchStatefulSet allows injecting arbitrary field to Prometheus StatefulSet. User is advised to use this field carefully as this field will do overwriting when there is conflict between PatchStatefulSet and the original StatefulSet. | *appsv1.StatefulSet | false |
...
| patchStatefulSet | PatchStatefulSet allows injecting arbitrary field to ThanosRuler StatefulSet. User is advised to use this field carefully as this field will do overwriting when there is conflict between PatchStatefulSet and the original StatefulSet. | *appsv1.StatefulSet | false |
