...
| enableAdminAPI | Enable access to prometheus web admin API. Defaults to the value of `true`. For more information see https://prometheus.io/docs/prometheus/latest/querying/api/#tsdb-admin-apis | string | false |
