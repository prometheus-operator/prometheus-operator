...
<p>The <code>PodMonitor</code> object introduced by the Prometheus Operator discovers pods and generates the relevant configuration for the Prometheus server to monitor them.</p>
