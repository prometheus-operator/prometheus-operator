...
Usage of ./operator:
  ...
  -watch-object-references-in-all-namespaces
    	When true the operator watches for configmaps and secrets in the union of workload and configuration resource namespaces.
