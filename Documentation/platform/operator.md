...
Usage of ./operator:
  ...
  -feature-gates value
    	...
    	Available feature gates:
    	  ...
    	  PrometheusAgentDaemonSetServiceMonitor: Enables ServiceMonitor support for PrometheusAgent DaemonSet mode using EndpointSlice (enabled: false)
  ...
  -prometheus-config-reloader string
    	Prometheus config reloader image (default "quay.io/prometheus-operator/prometheus-config-reloader:v0.84.1")
