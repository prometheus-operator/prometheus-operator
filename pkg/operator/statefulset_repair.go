...
func ResolveStuckStatefulSet(ctx context.Context, logger *slog.Logger, kclient kubernetes.Interface, sset *appsv1.StatefulSet, policy monitoringv1.RepairPolicy) error {
