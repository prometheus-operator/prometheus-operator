...
type AlertmanagerConfigSpec struct {
	// route defines the Alertmanager route definition for incoming alerts, depending on the Alertmanager's
...
type Route struct {
	...
	// namespace>` matcher, unless configured otherwise in Alertmanager's AlertmanagerConfigMatcherStrategyType.
	// +optional
