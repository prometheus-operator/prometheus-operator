...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProbeTargetDynamicConfig) DeepCopyInto(out *ProbeTargetDynamicConfig) {
	*out = *in
	if in.KubernetesSDConfig != nil {
		in, out := &in.KubernetesSDConfig, &out.KubernetesSDConfig
		*out = new(KubernetesSDConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.RelabelConfigs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProbeTargetDynamicConfig.
func (in *ProbeTargetDynamicConfig) DeepCopy() *ProbeTargetDynamicConfig {
	if in == nil {
		return nil
	}
	out := new(ProbeTargetDynamicConfig)
	in.DeepCopyInto(out)
	return out
}
