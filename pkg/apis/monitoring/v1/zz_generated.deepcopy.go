...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertmanagerConfigReloaderWebSpec) DeepCopyInto(out *AlertmanagerConfigReloaderWebSpec) {
	*out = *in
	in.WebConfigFileFields.DeepCopyInto(&out.WebConfigFileFields)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertmanagerConfigReloaderWebSpec.
func (in *AlertmanagerConfigReloaderWebSpec) DeepCopy() *AlertmanagerConfigReloaderWebSpec {
	if in == nil {
		return nil
	}
	out := new(AlertmanagerConfigReloaderWebSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AlertmanagerSpec) DeepCopyInto(out *AlertmanagerSpec) {
	*out = *in
	...
	if in.WebConfigReloader != nil {
		in, out := &in.WebConfigReloader, &out.WebConfigReloader
		*out = new(AlertmanagerConfigReloaderWebSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *CommonPrometheusFields) DeepCopyInto(out *CommonPrometheusFields) {
	*out = *in
	...
	if in.WebConfigReloader != nil {
		in, out := &in.WebConfigReloader, &out.WebConfigReloader
		*out = new(PrometheusConfigReloaderWebSpec)
		(*in).DeepCopyInto(*out)
	}
	in.Resources.DeepCopyInto(&out.Resources)
	if in.NodeSelector != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrometheusConfigReloaderWebSpec) DeepCopyInto(out *PrometheusConfigReloaderWebSpec) {
	*out = *in
	in.WebConfigFileFields.DeepCopyInto(&out.WebConfigFileFields)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrometheusConfigReloaderWebSpec.
func (in *PrometheusConfigReloaderWebSpec) DeepCopy() *PrometheusConfigReloaderWebSpec {
	if in == nil {
		return nil
	}
	out := new(PrometheusConfigReloaderWebSpec)
