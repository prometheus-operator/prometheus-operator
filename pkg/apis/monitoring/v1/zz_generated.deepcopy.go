...
func (in *PrometheusStatus) DeepCopyInto(out *PrometheusStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]PrometheusCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RemoteWriteSpec) DeepCopyInto(out *RemoteWriteSpec) {
	*out = *in
	in.RemoteWriteSpecV2.DeepCopyInto(&out.RemoteWriteSpecV2)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RemoteWriteSpecV2) DeepCopyInto(out *RemoteWriteSpecV2) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RemoteWriteSpecV2.
func (in *RemoteWriteSpecV2) DeepCopy() *RemoteWriteSpecV2 {
	if in == nil {
		return nil
	}
	out := new(RemoteWriteSpecV2)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ThanosRulerSpec) DeepCopyInto(out *ThanosRulerSpec) {
	*out = *in
	...
	if in.RemoteWriteConfig != nil {
		...
		*out = make([]RemoteWriteSpecV2, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.RemoteWriteConfigFile != nil {
		in, out := &in.RemoteWriteConfigFile, &out.RemoteWriteConfigFile
		*out = new(string)
		**out = **in
	}
}
