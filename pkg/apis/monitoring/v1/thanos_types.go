...
type ThanosRulerSpec struct {
	...
	// volumeMounts defines how configuration of additional VolumeMounts on the output StatefulSet definition.
	...
	// TalertQueryUrl defines how Thanos Ruler will set in the 'Source' field
	// of all alerts.
	...
	// specification defines the list of remote write configurations.
	//
