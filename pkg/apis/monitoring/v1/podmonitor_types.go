...
type PodMonitorSpec struct {
	// jobLabel is the label to use to retrieve the job name from.
	...
	// selector is the label selector to select the Kubernetes `Pod` objects to scrape metrics from.
	// +required
...
type PodMetricsEndpoint struct {
	...
	// targetPort dedines the name or number of the target port of the `Pod` object behind the Service, the
