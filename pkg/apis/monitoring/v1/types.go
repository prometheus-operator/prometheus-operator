...
// AdditionalScrapeConfigs defines parameters for additional scrape configuration of Prometheus
// +k8s:openapi-gen=true
type AdditionalScrapeConfigs struct {
	v1.SecretKeySelector `json:",inline"`
	// If EnableShards is true, target will split according to the sharding strategy.
