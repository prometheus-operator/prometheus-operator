...
// EmbeddedRollingUpdateStatefulSetStrategy is a flattened version of appsv1.RollingUpdateStatefulSetStrategy
// with the addition of the RepairPolicy field.
type EmbeddedRollingUpdateStatefulSetStrategy struct {
	appsv1.RollingUpdateStatefulSetStrategy `json:",inline"`
...
type StatefulSetUpdateStrategy struct {
	...
	// +optional
	RollingUpdate *EmbeddedRollingUpdateStatefulSetStrategy `json:"rollingUpdate,omitempty" protobuf:"bytes,2,opt,name=rollingUpdate"`
}
