...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KumaSDConfigs) DeepCopyInto(out *KumaSDConfigs) {
	{
		in := &in
		*out = make(KumaSDConfigs, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KumaSDConfigs.
func (in KumaSDConfigs) DeepCopy() KumaSDConfigs {
	if in == nil {
		return nil
	}
	out := new(KumaSDConfigs)
	in.DeepCopyInto(out)
	return *out
}
