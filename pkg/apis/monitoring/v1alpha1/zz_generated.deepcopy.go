...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OutscaleSDConfig) DeepCopyInto(out *OutscaleSDConfig) {
	*out = *in
	if in.Region != nil {
		in, out := &in.Region, &out.Region
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OutscaleSDConfig.
func (in *OutscaleSDConfig) DeepCopy() *OutscaleSDConfig {
	if in == nil {
		return nil
	}
	out := new(OutscaleSDConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScrapeConfigSpec) DeepCopyInto(out *ScrapeConfigSpec) {
	*out = *in
	...
	if in.OutscaleSDConfigs != nil {
		in, out := &in.OutscaleSDConfigs, &out.OutscaleSDConfigs
		*out = make([]OutscaleSDConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
