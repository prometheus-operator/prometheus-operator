...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SilenceBinding) DeepCopyInto(out *SilenceBinding) {
	*out = *in
	...
	if in.Conditions != nil {
		...
		*out = make([]monitoringv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SilenceBinding.
func (in *SilenceBinding) DeepCopy() *SilenceBinding {
	if in == nil {
		return nil
	}
	out := new(SilenceBinding)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SilenceStatus) DeepCopyInto(out *SilenceStatus) {
	*out = *in
	if in.Bindings != nil {
		...
		*out = make([]SilenceBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
