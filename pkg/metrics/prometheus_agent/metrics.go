...
type conditionCollector struct {
	seq iter.Seq[*monitoringv1alpha1.PrometheusAgent]
}

func NewConditionCollector(seq iter.Seq[*monitoringv1alpha1.PrometheusAgent]) prometheus.Collector {
	return &conditionCollector{
		seq: seq,
	}
}

const resourceType = "prometheus_agent"
