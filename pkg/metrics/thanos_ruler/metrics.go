...
type conditionCollector struct {
	seq iter.Seq[*monitoringv1.ThanosRuler]
}

func NewConditionCollector(seq iter.Seq[*monitoringv1.ThanosRuler]) prometheus.Collector {
	return &conditionCollector{
		seq: seq,
	}
}

const resourceType = "thanos_ruler"
