...
func (b *ConsulSDConfigApplyConfiguration) WithHTTPHeaders(values ...*applyconfigurationmonitoringv1.HTTPHeaderApplyConfiguration) *ConsulSDConfigApplyConfiguration {
	for i := range values {
		if values[i] == nil {
