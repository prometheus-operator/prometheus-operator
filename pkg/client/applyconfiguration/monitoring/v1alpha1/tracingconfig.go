...
type TracingConfigApplyConfiguration struct {
	...
	ClientType *monitoringv1alpha1.TracingClientType `json:"clientType,omitempty"`
...
func (b *TracingConfigApplyConfiguration) WithClientType(value monitoringv1alpha1.TracingClientType) *TracingConfigApplyConfiguration {
	b.ClientType = &value
	return b
}
