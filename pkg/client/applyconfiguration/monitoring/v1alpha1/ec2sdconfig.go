...
func (b *EC2SDConfigApplyConfiguration) WithHTTPHeaders(entries map[string]applyconfigurationmonitoringv1.HTTPHeaderApplyConfiguration) *EC2SDConfigApplyConfiguration {
