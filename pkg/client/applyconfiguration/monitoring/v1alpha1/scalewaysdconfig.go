...
func (b *ScalewaySDConfigApplyConfiguration) WithHTTPHeaders(values ...*applyconfigurationmonitoringv1.HTTPHeaderApplyConfiguration) *ScalewaySDConfigApplyConfiguration {
	for i := range values {
		if values[i] == nil {
