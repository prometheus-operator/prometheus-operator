...
type DockerSDConfigApplyConfiguration struct {
	...
	Filters                          *v1alpha1.DockerConfigSelectors         `json:"filters,omitempty"`
...
func (b *DockerSDConfigApplyConfiguration) WithFilters(value v1alpha1.DockerConfigSelectors) *DockerSDConfigApplyConfiguration {
	b.Filters = &value
	return b
}
