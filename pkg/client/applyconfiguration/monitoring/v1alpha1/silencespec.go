...
type SilenceSpecApplyConfiguration struct {
	...
	AlertmanagerRef *AlertmanagerRefApplyConfiguration `json:"alertmanagerRef,omitempty"`
}
...
// WithAlertmanagerRef sets the AlertmanagerRef field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the AlertmanagerRef field is set to the value of the last call.
func (b *SilenceSpecApplyConfiguration) WithAlertmanagerRef(value *AlertmanagerRefApplyConfiguration) *SilenceSpecApplyConfiguration {
	b.AlertmanagerRef = value
	return b
}
