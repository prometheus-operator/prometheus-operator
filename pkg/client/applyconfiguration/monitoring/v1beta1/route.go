...
type RouteApplyConfiguration struct {
	...
	GroupInterval       *monitoringv1.Duration      `json:"groupInterval,omitempty"`
	RepeatInterval      *monitoringv1.Duration      `json:"repeatInterval,omitempty"`
...
func (b *RouteApplyConfiguration) WithGroupInterval(value monitoringv1.Duration) *RouteApplyConfiguration {
...
func (b *RouteApplyConfiguration) WithRepeatInterval(value monitoringv1.Duration) *RouteApplyConfiguration {
