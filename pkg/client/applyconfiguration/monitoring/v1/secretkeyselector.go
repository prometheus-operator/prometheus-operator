...
type SecretKeySelectorApplyConfiguration struct {
	*SecretReferenceApplyConfiguration `json:"secretRef,omitempty"`
...
func (b *SecretKeySelectorApplyConfiguration) WithName(value string) *SecretKeySelectorApplyConfiguration {
	b.ensureSecretReferenceApplyConfigurationExists()
	b.SecretReferenceApplyConfiguration.Name = &value
	return b
}

func (b *SecretKeySelectorApplyConfiguration) ensureSecretReferenceApplyConfigurationExists() {
	if b.SecretReferenceApplyConfiguration == nil {
		b.SecretReferenceApplyConfiguration = &SecretReferenceApplyConfiguration{}
	}
}
