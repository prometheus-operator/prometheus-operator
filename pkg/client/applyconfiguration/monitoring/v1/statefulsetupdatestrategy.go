...
type StatefulSetUpdateStrategyApplyConfiguration struct {
	...
	RollingUpdate *EmbeddedRollingUpdateStatefulSetStrategyApplyConfiguration `json:"rollingUpdate,omitempty"`
}
...
func (b *StatefulSetUpdateStrategyApplyConfiguration) WithRollingUpdate(value *EmbeddedRollingUpdateStatefulSetStrategyApplyConfiguration) *StatefulSetUpdateStrategyApplyConfiguration {
