...
func (b *ProbeSpecApplyConfiguration) WithAlwaysScrapeClassicHistograms(value bool) *ProbeSpecApplyConfiguration {
	b.NativeHistogramConfigApplyConfiguration.AlwaysScrapeClassicHistograms = &value
	return b
}
