...
func (b *PrometheusSpecApplyConfiguration) WithNodeSelector(value monitoringv1.NodeSelector) *PrometheusSpecApplyConfiguration {
	b.CommonPrometheusFieldsApplyConfiguration.NodeSelector = &value
	return b
}
