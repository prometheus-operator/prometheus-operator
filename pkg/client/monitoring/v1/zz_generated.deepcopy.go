...
func GetGeneratedDeepCopyFuncs() []conversion.GeneratedDeepCopyFunc {
	return []conversion.GeneratedDeepCopyFunc{
		...
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*SkipMetricConfig).DeepCopyInto(out.(*SkipMetricConfig))
			return nil
		}, InType: reflect.TypeOf(&SkipMetricConfig{})},
		{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
...
func (in *Endpoint) DeepCopyInto(out *Endpoint) {
	*out = *in
	...
	if in.SkipMetrics != nil {
		in, out := &in.SkipMetrics, &out.SkipMetrics
		*out = make([]*SkipMetricConfig, len(*in))
		for i := range *in {
			if (*in)[i] == nil {
				(*out)[i] = nil
			} else {
				(*out)[i] = new(SkipMetricConfig)
				(*in)[i].DeepCopyInto((*out)[i])
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SkipMetricConfig) DeepCopyInto(out *SkipMetricConfig) {
	*out = *in
	if in.Source != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SkipMetricConfig.
func (in *SkipMetricConfig) DeepCopy() *SkipMetricConfig {
	if in == nil {
		return nil
	}
	out := new(SkipMetricConfig)
	in.DeepCopyInto(out)
	return out
}
