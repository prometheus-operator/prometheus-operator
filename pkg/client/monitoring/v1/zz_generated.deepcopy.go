...
func (in *AlertmanagerSpec) DeepCopyInto(out *AlertmanagerSpec) {
	*out = *in
	...
	if in.CACertBundle != nil {
		in, out := &in.CACertBundle, &out.CACertBundle
		if *in == nil {
			*out = nil
		} else {
			*out = new(CACertBundleSpec)
			(*in).DeepCopyInto(*out)
		}
	}
	if in.Replicas != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CACertBundleSpec) DeepCopyInto(out *CACertBundleSpec) {
	*out = *in
	if in.MountPath != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CACertBundleSpec.
func (in *CACertBundleSpec) DeepCopy() *CACertBundleSpec {
	if in == nil {
		return nil
	}
	out := new(CACertBundleSpec)
