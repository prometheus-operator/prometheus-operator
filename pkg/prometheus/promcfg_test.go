...
func TestScrapeConfigSpecConfigWithIonosSD(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name: "ionos_sd_config_basicauth",
			scSpec: monitoringv1alpha1.ScrapeConfigSpec{
				IonosSDConfigs: []monitoringv1alpha1.IonosSDConfig{
					{
						DatacenterId: "11111111-1111-1111-1111-111111111111",
			...
			golden: "ScrapeConfigSpecConfig_IonosSD_withBasicAuth.golden",
		},
		{
			name: "ionos_sd_config_oauth",
			scSpec: monitoringv1alpha1.ScrapeConfigSpec{
				IonosSDConfigs: []monitoringv1alpha1.IonosSDConfig{
					{
						DatacenterId: "11111111-1111-1111-1111-111111111111",
			...
			golden: "ScrapeConfigSpecConfig_IonosSD_withOauth.golden",
		},
		{
