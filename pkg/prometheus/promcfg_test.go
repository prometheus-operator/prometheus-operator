...
func TestScrapeConfigSpecConfigWithStackitSD(t *testing.T) {
	for _, tc := range []struct {
		name   string
		scSpec monitoringv1alpha1.ScrapeConfigSpec
		golden string
	}{
		{
			...
			golden: "ScrapeConfigSpecConfig_StackitSDConfigs.golden",
		},
		{
			name: "stackit_sd_config_oauth",
			scSpec: monitoringv1alpha1.ScrapeConfigSpec{
				StackitSDConfigs: []monitoringv1alpha1.StackitSDConfig{
					{
						Project:  "11111111-1111-1111-1111-111111111111",
			...
			golden: "ScrapeConfigSpecConfig_StackitSDConfigs_with_OAuth.golden",
		}, {
			name: "stackit_sd_config_tls",
			scSpec: monitoringv1alpha1.ScrapeConfigSpec{
				StackitSDConfigs: []monitoringv1alpha1.StackitSDConfig{
					{
						Project:  "11111111-1111-1111-1111-111111111111",
			...
			golden: "ScrapeConfigSpecConfig_StackitSDConfigs_with_TLSConfig.golden",
		}} {
		t.Run(tc.name, func(t *testing.T) {
			store := assets.NewTestStoreBuilder(
				&v1.Secret{
