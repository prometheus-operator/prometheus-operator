...
func TestSettingJobNameInServiceMonitor(t *testing.T) {
	cg := &configGenerator{}
	cfg, err := cg.generateConfig(
		&monitoringv1.Prometheus{
			ObjectMeta: metav1.ObjectMeta{
...
- job_name: my-service-monitor
  ...
  - source_labels:
    ...
    replacement: ${1}
  - target_label: job
    replacement: my-service-monitor
  - target_label: endpoint
    replacement: web
alerting:
  alert_relabel_configs:
...
func TestSettingJobNameInPodMonitor(t *testing.T) {
	cg := &configGenerator{}
	cfg, err := cg.generateConfig(
		&monitoringv1.Prometheus{
			ObjectMeta: metav1.ObjectMeta{
