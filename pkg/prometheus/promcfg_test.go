			...
			Endpoints: []monitoringv1.Endpoint{
				{
					...
					Interval: "30s",
					Path:     "/federate",
					Params:   []monitoringv1.ParamEntry{{Name: "match[]", Values: []string{"{__name__=~\"job:.*\"}"}}},
				},
			},
		},
	}
			...
			PodMetricsEndpoints: []monitoringv1.PodMetricsEndpoint{
				{
					...
					Interval: "30s",
					Path:     "/federate",
					Params:   []monitoringv1.ParamEntry{{Name: "metrics[]", Values: []string{"{__name__=~\"job:.*\"}"}}},
				},
			},
		},
	}
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			scSpec: monitoringv1alpha1.ScrapeConfigSpec{
				...
				Params:      []monitoringv1alpha1.ParamEntry{{Name: "match[]", Values: []string{"{job=\"prometheus\"}", "{__name__=~\"job:.*\"}"}}},
			},
