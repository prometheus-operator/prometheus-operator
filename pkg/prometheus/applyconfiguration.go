...
// func serviceMonitorStatusApplyConfigurationFromServiceMonitorStatus(status *monitoringv1.ConfigurationResourceStatus) *monitoringv1ac.ServiceMonitorStatusApplyConfiguration {
